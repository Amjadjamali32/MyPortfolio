    ...
    <>
      <section id='contact' className={`py-8 ${darkMode ? 'bg-dark' : 'bg-light'} mb-4`}>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 sm:mb-10 md:mb-12">
          <div className={`p-6 rounded-lg ${darkMode ? 'bg-dark md:shadow-md' : 'bg-white md:shadow-lg'} flex flex-col justify-center col-span-1 md:col-span-2`}>
            <h2 className={`text-3xl text-center font-extrabold my-6 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Get in touch &darr;</h2>
            <form
            ...
            >
              ...
              {/* reCAPTCHA */}
              <div className="g-recaptcha" data-sitekey="6LeEUGIqAAAAAJeRix0GZ5kM5jMajtrYYpC-4sIR"></div>
